...
// Currently 24 pixels wide x 64 pixels high
static const char __attribute__((unused)) font_digits_univers[FONT_DIGIT_COUNT][FONT_DIGIT_HEIGHT][FONT_DIGIT_ROW_BYTES] = {

    // Font: Univers Next Pro (.60720.otf)
    // Cell: 24x64
    // Auto-fit from raster ink bounds
    // Source max ink bounds: 583x755
    // Shared scales: 0.041166x horizontal, 0.084768x vertical
...
static const char __attribute__((unused)) font_digits_helvetica[FONT_DIGIT_COUNT][FONT_DIGIT_HEIGHT][FONT_DIGIT_ROW_BYTES] = {
    // Font: Helvetica (Helvetica.ttc)
    // Cell: 24x64
    // Auto-fit from raster ink bounds
    // Source max ink bounds: 498x720
    // Shared scales: 0.048193x horizontal, 0.088889x vertical
...
#define font_digits font_digits_univers
